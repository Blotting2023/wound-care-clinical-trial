...
class AuthService {
  ...
  /// Returns a map with [token], [userId] and [displayName] on success.
  Future<Map<String, dynamic>> login({
    ...
    if (data != null && data['token'] != null) {
      ...
      if (userId.isNotEmpty && !ApiConfig.demoMode) {
        await _secureStorage.write(key: 'user_id', value: userId);
      }
      return {'token': token, 'userId': userId, 'displayName': displayName};
    }
